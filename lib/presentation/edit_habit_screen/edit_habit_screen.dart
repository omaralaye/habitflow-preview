...
class _EditHabitScreenState extends State<EditHabitScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!_initialized) {
      ...
      final habit = args is Map<String, dynamic> ? args : <String, dynamic>{};

      _nameController.text =
          (habit['name'] as String?) ?? (habit['title'] as String?) ?? '';
      _selectedCategory = (habit['category'] as String?) ?? 'Health';
      _selectedFrequency = (habit['frequency'] as String?) ?? 'Daily';
      _reminderEnabled = (habit['reminderEnabled'] as bool?) ?? true;

      final reminderTimeStr = habit['reminderTime'] as String?;
